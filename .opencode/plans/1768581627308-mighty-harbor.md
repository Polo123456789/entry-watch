...
- In progress:
  - [ ] Implement cookie/session-backed login/logout handlers
- Next up:
  - [ ] Add `gorilla/sessions` store and update `CanonicalLoggerMiddleware` to read session and populate context
